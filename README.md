...
Exploring the History of Playing Cards through Gesture. We are designing embodied, playful, and accessible interactive experiences that tell the stories behind playing card suits for the Swiss Museum of Games.
...
- [code/](code) — p5.js and creative coding prototypes.
- [process/journal.md](process/journal.md) — Development journal

## Team
[Alireza Asnavandi](https://github.com/AlirezaAsna/head-md-oracle-of-suits) & Antony Neyret
